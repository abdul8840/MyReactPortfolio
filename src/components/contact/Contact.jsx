        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">+91 8840351748</span>

              <a href="www.instagram.com" className="contact-button">
                Write Me{" "}
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
              </a>
            </div>
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">+91 7081434589</span>
